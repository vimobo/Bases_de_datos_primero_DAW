...
select count(*) as filas from city;
...
select * from city where name like 'Bratislava';

-- 9 

select * from city where population > 670000 &&  population < 700000;
...
select sum(population) as nypopulation from city where district = 'New York'; 

-- 14

select sum(population) as usapopulation from city where countrycode = 'USA';

select * from city where countrycode = 'USA' && population > 3000000;
...
select name as nombre, gnp as PIB, gnpold as PEB, (GNP-GNPOLD) as diferencia from country;
...
select name, code, indepyear from country order by indepyear asc; 

-- 10

select name, continent from country order by lifexpectancy desc, surfacearea asc;
...
select * from country where lifexpectancy > 75;

-- 13

use world;

select * from country where indepyear > 1850 && GovernmentForm = 'Constitutional Monarchy';
...
select * from city where CountryCode = 'ARG' && District != 'Buenos Aires';

-- 20

select * from city where population >12500 && population < 130000;
...
select country.name, ciry.name from country, city
where country.capital = city.id
and continent = 'South America';

-- 27

select country.code, country.population, city.name 
from country 
inner join city 
